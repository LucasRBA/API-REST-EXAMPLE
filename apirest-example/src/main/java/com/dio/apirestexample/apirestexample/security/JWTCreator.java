...
public class JWTCreator {
    ...
    public static JWTObject create(String token, String prefix, String key)
        ...
        //allowedskewfor current gmt -4 jwt verification
        Claims claims = Jwts.parser().setAllowedClockSkewSeconds(14400).setSigningKey(key).parseClaimsJws(token).getBody();
